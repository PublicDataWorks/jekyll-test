...
Please refer to the **README.md** in the **instance_files_pm** repository for instructions on how to test locally or follow the instructions below:


```
Setup the `INSTANCE_FILES_DIR` environment variable on your local machine to point it to the `instance-files` directory within this repository.
...
Ex: In terminal: open ~/.zshrc
Ex: In file: export INSTANCE_FILES_DIR="[paste path here]"
